...
const PHONE_RICH_MEDIA=Object.freeze({
  ...
  ,"apple|iphone 8":{hero:null,colors:appleStoreColorMedia("iphone8-",[{name:"Silver",slug:"silver"},{name:"Space Gray",slug:"space-gray"},{name:"Gold",slug:"gold"}],"-select-2017"),views:[],finishes:["Silver","Space Gray","Gold","(PRODUCT)RED"]}
  ,"apple|iphone 8 plus":{hero:null,colors:appleStoreColorMedia("iphone8-plus-",[{name:"Silver",slug:"silver"},{name:"Space Gray",slug:"space-gray"},{name:"Gold",slug:"gold"}],"-select-2017"),views:[],finishes:["Silver","Space Gray","Gold","(PRODUCT)RED"]}
  ,"apple|iphone xr":{hero:null,colors:appleStoreColorMedia("iphone-xr-",[{name:"Black",slug:"black"},{name:"White",slug:"white"},{name:"Blue",slug:"blue"},{name:"Yellow",slug:"yellow"},{name:"Coral",slug:"coral"},{name:"(PRODUCT)RED",slug:"red"}],"-select-201809"),views:[],finishes:["Black","White","Blue","Yellow","Coral","(PRODUCT)RED"]}
  ,"apple|iphone xs":{hero:null,colors:appleStoreColorMedia("iphone-xs-",[{name:"Space Gray",slug:"spacegray"},{name:"Silver",slug:"silver"},{name:"Gold",slug:"gold"}],"-select-2018"),views:[],finishes:["Space Gray","Silver","Gold"]}
  ,"apple|iphone xs max":{hero:null,colors:appleStoreColorMedia("iphone-xs-max-",[{name:"Space Gray",slug:"spacegray"},{name:"Silver",slug:"silver"},{name:"Gold",slug:"gold"}],"-select-2018"),views:[],finishes:["Space Gray","Silver","Gold"]}
  ,"apple|iphone 11 pro":{hero:null,colors:appleStoreColorMedia("iphone-11-pro-",[{name:"Midnight Green",slug:"midnight-green"},{name:"Space Gray",slug:"space-gray"},{name:"Silver",slug:"silver"},{name:"Gold",slug:"gold"}],"-select-2019"),views:[],finishes:["Midnight Green","Space Gray","Silver","Gold"]}
  ,"apple|iphone 11 pro max":{hero:null,colors:appleStoreColorMedia("iphone-11-pro-max-",[{name:"Midnight Green",slug:"midnight-green"},{name:"Space Gray",slug:"space-gray"},{name:"Silver",slug:"silver"},{name:"Gold",slug:"gold"}],"-select-2019"),views:[],finishes:["Midnight Green","Space Gray","Silver","Gold"]}
  ,"apple|iphone se 2020":{hero:null,colors:appleStoreColorMedia("iphone-se-",[{name:"Black",slug:"black"},{name:"White",slug:"white"},{name:"(PRODUCT)RED",slug:"red"}],"-select-2020"),views:[],finishes:["Black","White","(PRODUCT)RED"]}
  ,"apple|iphone 17":{hero:null,colors:appleStoreColorMedia("iphone-17-finish-select-202509-",[{name:"Black",slug:"black_GEO_US"},{name:"White",slug:"white_GEO_US"},{name:"Mist Blue",slug:"mistblue_GEO_US"},{name:"Sage",slug:"sage_GEO_US"},{name:"Lavender",slug:"lavender_GEO_US"}]),views:[],finishes:["Black","White","Mist Blue","Sage","Lavender"]}
  ,"apple|iphone 17 pro":{hero:null,colors:appleStoreColorMedia("iphone-17-pro-finish-select-202509-6-3inch-",[{name:"Cosmic Orange",slug:"cosmicorange"},{name:"Deep Blue",slug:"deepblue"},{name:"Silver",slug:"silver"}]),views:[],finishes:["Cosmic Orange","Deep Blue","Silver"]}
  ,"apple|iphone 17 pro max":{hero:null,colors:appleStoreColorMedia("iphone-17-pro-finish-select-202509-6-9inch-",[{name:"Cosmic Orange",slug:"cosmicorange"},{name:"Deep Blue",slug:"deepblue"},{name:"Silver",slug:"silver"}]),views:[],finishes:["Cosmic Orange","Deep Blue","Silver"]}
